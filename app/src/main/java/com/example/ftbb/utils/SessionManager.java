package com.example.ftbb.utils;

import android.content.Context;
import android.content.Intent;
import android.content.SharedPreferences;

import com.example.ftbb.LoginActivity;
...
public class SessionManager {
    ...
    public user getUserDetails() {
        ...
        if(AppDataBase.getAppDatabase(this._context).userDao().findByEmail(KEY_EMAIL)==null)
        {

        }
        else
        {
            user=AppDataBase.getAppDatabase(this._context).userDao().findByEmail(KEY_EMAIL);
        }
